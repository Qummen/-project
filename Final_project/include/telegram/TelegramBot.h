...
namespace telegram {
	...
	private:
        ...
        void pollUpdates();
        void sendMessage(std::int64_t chatId, const std::string& text, const std::string& replyMarkupJson = "") const;
        void answerCallbackQuery(const std::string& callbackId) const;
    public:
